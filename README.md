...
O [ESLint](https://eslint.org/) para fazer a análise estática do seu código.
...
Utilizado o plugin do `ESLint` no `VSCode`, baixado em [plugin `ESLint`](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint).
